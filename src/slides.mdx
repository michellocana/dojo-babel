...
<img src='/images/lexical-analysis.png' alt='Análise Léxica' style={{ width: '100%', maxWidth: 1200, margin: '0 auto' }} />
...
{`const foodsILike = [
  ...
  <div style={{ flex: 60, paddingLeft: 40 }}>
    <img src="/images/ast.svg" alt="AST" width="100%" />
  </div>
</div>
...
>
  <li style={{ flex: 0, margin: 25 }}>
    <img src="/images/vscode.svg" height="150" alt="foo" />
  </li>
  <li style={{ flex: 0, margin: 25 }}>
    <img src="/images/eslint.svg" height="150" alt="foo" />
  </li>
  <li style={{ flex: 0, margin: 25 }}>
    <img src="/images/prettier.svg" height="150" alt="foo" />
  </li>
  <li style={{ flex: 0, margin: 25 }}>
    <img src="/images/typescript.svg" height="150" alt="foo" />
  </li>
  <li style={{ flex: 0, margin: 25 }}>
    <img src="/images/flow.svg" height="150" alt="foo" />
  </li>
  <li style={{ flex: 0, margin: 25 }}>
    <img src="/images/graphql.svg" height="150" alt="foo" />
  </li>
  <li style={{ flex: 0, margin: 25 }}>
    <img src="/images/babel.svg" height="150" alt="foo" />
  </li>
</ul>
...
<div style={{ display: 'flex', justifyContent: 'center' }}>
  <img src="/images/babel-time-travel.png" alt="Babel Time Travel" style={{ flex: 0 }} />
</div>
